...
CREATE TABLE `alumnos` (
  ...
  `estatus` enum('activo','inactivo','pendiente') COLLATE utf8mb4_unicode_ci DEFAULT 'activo',
  `tipo_alumno` enum('regular','prueba') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'regular',
...
INSERT INTO `refresh_tokens` VALUES (1,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImlhdCI6MTc1MDAyMDE2NywiZXhwIjoxNzUwNjI0OTY3fQ.PzgOt6nsFQDZRKDD9BH-FqCIpYUMlznYQJok4V_rnYE','2025-06-15 20:42:47','2025-06-15 20:42:47'),(3,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjMsImlhdCI6MTc0OTk0NTMxOCwiZXhwIjoxNzUwNTUwMTE4fQ.eeE3CjVDdiIG0izGiRT9P6kR69xOXaubgzCxpwDZNJo','2025-06-14 23:02:36','2025-06-14 23:55:18');
...
-- Dump completed on 2025-06-15 15:25:12
