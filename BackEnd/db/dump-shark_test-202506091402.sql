...
--
-- Host: localhost    Database: shark_test
-- ------------------------------------------------------
...
CREATE TABLE `alumnos` (
  ...
  `tipo` enum('regular','prueba') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'regular',
  ...
  `firma` char(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `cupones` (
  ...
  `tipo` enum('porcentaje','cantidad') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `grupos` (
  ...
  `codigo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo` enum('matronatacion','nado_libre','aqua_fitness','natacion_infantil','natacion_adultos') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `productos` (
  ...
  `nombre` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci,
  `categoria` enum('cafeteria','articulo_deportivo','accesorios') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tarifas_mensualidad` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tipo_clase` enum('matronatacion','nado_libre','aqua_fitness','natacion_infantil','natacion_adultos') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `transacciones` (
  `id` int NOT NULL AUTO_INCREMENT,
  `folio` int NOT NULL,
  `tipo_transaccion` enum('inscripcion','mensualidad','producto','descuento') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('admin','cajero','profesor','usuario') COLLATE utf8mb4_unicode_ci DEFAULT 'usuario',
  `activo` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `usuarios` VALUES (1,'admin','admin@escuelanatacion.com','$2y$10$YourHashedPasswordHere','admin',1,'2025-06-09 03:10:51','2025-06-09 03:10:51'),(2,'cajero1','cajero1@escuelanatacion.com','$2y$10$YourHashedPasswordHere','cajero',1,'2025-06-09 03:10:51','2025-06-09 03:10:51');
...
--
-- Dumping routines for database 'shark_test'
--
...
-- Dump completed on 2025-06-09 14:02:17
