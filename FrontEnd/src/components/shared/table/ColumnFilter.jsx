...
export function ColumnFilter({ column, placeholder = "Buscar..." }) {
  const columnFilterValue = column?.getFilterValue();

  // Trata 'dateRange' como campo de texto normal
    ...
    return (
      <Input
        ...
        classNames={{
          root: "mt-0.5",
          input:
            "min-w-[8rem] rounded-none border-0 border-b px-0 pb-1.5 text-xs-plus",
        }}
      />
    );
  }
