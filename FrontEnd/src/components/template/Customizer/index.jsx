    ...
    <>
      <div className="flex items-center justify-between px-3 py-2">
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          <span>Personalizador de Tema</span>
        </div>
        <Button
          onClick={close}
          variant="flat"
            ...
            <Radio value="system" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  <p className="mt-1.5 text-center text-xs-plus">Sistema</p>
                </>
              )}
            </Radio>
            ...
            <Radio value="dark" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  />
                  <p className="mt-1.5 text-center text-xs-plus">Oscuro</p>
                </>
              )}
            </Radio>
          </div>
            ...
            <Radio value="main-layout" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  <p className="mt-1.5 text-center text-xs-plus">Diseño Principal</p>
                </>
              )}
            </Radio>
            ...
            <Radio value="sideblock" className="cursor-pointer outline-hidden">
              {({ checked }) => (
                <>
                  ...
                  <p className="mt-1.5 text-center text-xs-plus">Bloque Lateral</p>
                </>
              )}
            </Radio>
          </div>
