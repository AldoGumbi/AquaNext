    ...
    <Popover className="relative w-full">
      ...
      >
        <PopoverPanel
          ...
          className="absolute z-10 flex flex-col rounded-md border border-gray-300 bg-white text-xs-plus shadow-lg shadow-gray-200/50 outline-hidden ring-primary-500/50 focus-visible:outline-hidden focus-visible:ring-3 dark:border-dark-500 dark:bg-dark-750 dark:shadow-none"
        >
