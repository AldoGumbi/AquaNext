...
const BASE_DISPONIBILIDAD_URL = '/availability';
export const GET_DISPONIBILIDAD_POR_MES = BASE_DISPONIBILIDAD_URL + '/cupos';
export const GET_DISPONIBILIDAD_POR_RANGO = BASE_DISPONIBILIDAD_URL + '/cupos/rango';
